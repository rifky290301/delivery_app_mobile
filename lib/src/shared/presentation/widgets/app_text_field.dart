    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          filled: true,
          hintText: hintText,
          hintStyle: AppTextStyle.logoSubTitleBlack.copyWith(
            color: AppColors.hintText.withOpacity(.3),
            fontSize: 14,
          ),
          errorStyle: AppTextStyle.logoSubTitleBlack.copyWith(
            color: AppColors.danger,
          ),
        ),
        style: AppTextStyle.logoSubTitleBlack.copyWith(fontSize: 16),
